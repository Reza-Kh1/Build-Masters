...
const getData = async (): Promise<FaqsType> => {
      ...
      <div className="classDiv flex-col flex md:flex-row gap-3">
        <div className="w-full md:w-3/4">
          <section className="mb-3 md:mb-4">
            ...
            <span className="text-xs lg:text-base text-gray-700 dark:text-s-dark">{data?.content?.title}</span>
          </section>
          <div className="accordion flex flex-col gap-5 lg:gap-7">
            {data?.content?.accordion[0].name
              ? data?.content.accordion.map((i) => (
                <div key={i?.id}>
